    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex flex-col justify-between w-1/2 bg-brand p-12 relative overflow-hidden">
        ...
        <div className="z-10">
          <div className="inline-flex items-center gap-2 bg-white/20 text-white text-xs font-semibold px-3 py-1.5 rounded-full mb-6">
            <span>🧠</span> Discover Your Learning DNA
          </div>
          <h2 className="text-4xl font-extrabold text-white leading-tight mb-6">
            Start your<br /><span className="text-blue-200">personalized</span> learning journey.
          </h2>
              <p className="text-blue-100 text-sm mb-8">Join thousands of students who've unlocked their true learning potential. It only takes 5 minutes to get started.</p>
          <div className="space-y-3">
            {[
              'VARK Assessment — 16 questions to find your style.',
              'AI Study Buddy — Learn with Gemini-powered tutoring.',
              'Brain Dominance — Understand your cognitive strengths.',
            ].map((item) => (
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 py-10 bg-white dark:bg-gray-900 relative">
        <div className="w-full max-w-md">
          ...
          <p className="text-gray-500 dark:text-gray-400 text-sm mb-8">Start your personalized learning journey today.</p>
          ...
          <form className="space-y-4">
            <div>
              ...
              <div className="relative">
                <span className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400">
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" /></svg>
                </span>
                <input
                  type="text"
            ...
            <button type="submit" className="btn-primary w-full text-center py-3.5 mt-2 flex items-center justify-center gap-2">
              Create Account <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" d="M14 5l7 7m0 0l-7 7m7-7H3" /></svg>
            </button>
          </form>
